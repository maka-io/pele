 ...
 */
class DataElementCollection extends Mongo.Collection {
    /**
     * @public
 ...
 * You may modify (not recommended) these permissions on the DataElement.deny() line.
* @memberof Server.DataElement
* @member DataElement
*/
export const DataElement = new DataElementCollection('DataElement');
 ...
 * @see ./publications.js
 */
DataElement.publicFields = {};
DataElement.privateFields = {};
