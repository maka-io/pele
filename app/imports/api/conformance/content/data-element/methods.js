 ...
 */
const insertDataElement = new ValidatedMethod({
    name: 'data-element.insert',
    validate: null,
    run(doc) {
        //return DataElement.insert(doc);
    }
});
 ...
 * @property { function }   run         The main action that is executed.
 */
const updateDataElement  = new ValidatedMethod({
    name: 'data-element.update',
    validate: null,
    run([docId, obj]) {
        //return DataElement.update(docId, {$set: obj});
    }
});
 ...
 * @property { function }   run         The main action that is executed.
 */
const removeDataElement  = new ValidatedMethod({
    name: 'data-element.remove',
    validate: null,
    run(docId) {
        //return DataElement.remove(docId);
    }
});

const RATE_LIMITED_METHODS = _.pluck([
    insertDataElement , updateDataElement , removeDataElement
], 'name');
