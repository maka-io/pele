 ...
 */
class StructureDefinitionCollection extends Mongo.Collection {
    /**
     * @public
 ...
 * You may modify (not recommended) these permissions on the StructureDefinition.deny() line.
* @memberof Server.StructureDefinition
* @member StructureDefinition
*/
export const StructureDefinition = new StructureDefinitionCollection('StructureDefinition');

/**
 * Set the client side access rights to the Cases collection.
 * Default: Deny all
 */
StructureDefinition.deny({
    insert() { return true; },
    update() { return true; },
    remove() { return true; }
});
 ...
 * @see ./publications.js
 */
StructureDefinition.publicFields = {};
StructureDefinition.privateFields = {};
