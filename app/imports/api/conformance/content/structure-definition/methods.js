 ...
 */
const insertStructureDefinition = new ValidatedMethod({
    name: 'structure-definition.insert',
    validate: null,
    run(doc) {
        //return StructureDefinition.insert(doc);
    }
});
 ...
 * @property { function }   run         The main action that is executed.
 */
const updateStructureDefinition  = new ValidatedMethod({
    name: 'structure-definition.update',
    validate: null,
    run([docId, obj]) {
        //return StructureDefinition.update(docId, {$set: obj});
    }
});
 ...
 * @property { function }   run         The main action that is executed.
 */
const removeStructureDefinition  = new ValidatedMethod({
    name: 'structure-definition.remove',
    validate: null,
    run(docId) {
        //return StructureDefinition.remove(docId);
    }
});

const RATE_LIMITED_METHODS = _.pluck([
    insertStructureDefinition , updateStructureDefinition , removeStructureDefinition
], 'name');
