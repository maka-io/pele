 ...
 */
class ImplementationGuideCollection extends Mongo.Collection {
    /**
     * @public
 ...
 * You may modify (not recommended) these permissions on the ImplementationGuide.deny() line.
* @memberof Server.ImplementationGuide
* @member ImplementationGuide
*/
export const ImplementationGuide = new ImplementationGuideCollection('ImplementationGuide');

/**
 * Set the client side access rights to the Cases collection.
 * Default: Deny all
 */
ImplementationGuide.deny({
    insert() { return true; },
    update() { return true; },
    remove() { return true; }
});
 ...
 * @see ./publications.js
 */
ImplementationGuide.publicFields = {};
ImplementationGuide.privateFields = {};
