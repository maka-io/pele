 ...
 */
const ImplementationGuideApiV1 = new Restivus({
    version: 'v1',
    useDefaultAuth: true,
...
// Uncommenting below will expose ALL routes for ImplementationGuide
//
// Please review restivus documentation on how to harden endpoints.
//
// USE WITH CAUTION... can you imagine - $ maka g:api BankRecords
ImplementationGuideApiV1.addCollection(ImplementationGuide);
