 ...
 */
class TestScriptCollection extends Mongo.Collection {
    /**
     * @public
 ...
 * You may modify (not recommended) these permissions on the TestScript.deny() line.
* @memberof Server.TestScript
* @member TestScript
*/
export const TestScript = new TestScriptCollection('TestScript');
 ...
 * @see ./publications.js
 */
TestScript.publicFields = {};
TestScript.privateFields = {};
