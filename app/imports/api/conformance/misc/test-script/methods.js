 ...
 */
const insertTestScript = new ValidatedMethod({
    name: 'test-script.insert',
    validate: null,
    run(doc) {
        //return TestScript.insert(doc);
    }
});
 ...
 * @property { function }   run         The main action that is executed.
 */
const updateTestScript  = new ValidatedMethod({
    name: 'test-script.update',
    validate: null,
    run([docId, obj]) {
        //return TestScript.update(docId, {$set: obj});
    }
});
 ...
 * @property { function }   run         The main action that is executed.
 */
const removeTestScript  = new ValidatedMethod({
    name: 'test-script.remove',
    validate: null,
    run(docId) {
        //return TestScript.remove(docId);
    }
});

const RATE_LIMITED_METHODS = _.pluck([
    insertTestScript , updateTestScript , removeTestScript
], 'name');
