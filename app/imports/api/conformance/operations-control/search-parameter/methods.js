 ...
 */
const insertSearchParameter = new ValidatedMethod({
    name: 'search-parameter.insert',
    validate: null,
    run(doc) {
        //return SearchParameter.insert(doc);
    }
});
 ...
 * @property { function }   run         The main action that is executed.
 */
const updateSearchParameter  = new ValidatedMethod({
    name: 'search-parameter.update',
    validate: null,
    run([docId, obj]) {
        //return SearchParameter.update(docId, {$set: obj});
    }
});
 ...
 * @property { function }   run         The main action that is executed.
 */
const removeSearchParameter  = new ValidatedMethod({
    name: 'search-parameter.remove',
    validate: null,
    run(docId) {
        //return SearchParameter.remove(docId);
    }
});

const RATE_LIMITED_METHODS = _.pluck([
    insertSearchParameter , updateSearchParameter , removeSearchParameter
], 'name');
