 ...
 */
class SearchParameterCollection extends Mongo.Collection {
    /**
     * @public
 ...
 * You may modify (not recommended) these permissions on the SearchParameter.deny() line.
* @memberof Server.SearchParameter
* @member SearchParameter
*/
export const SearchParameter = new SearchParameterCollection('SearchParameter');

/**
 * Set the client side access rights to the Cases collection.
 * Default: Deny all
 */
SearchParameter.deny({
    insert() { return true; },
    update() { return true; },
    remove() { return true; }
});
 ...
 * @see ./publications.js
 */
SearchParameter.publicFields = {};
SearchParameter.privateFields = {};
