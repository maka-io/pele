 ...
 */
class ConformanceCollection extends Mongo.Collection {
    /**
     * @public
 ...
 * You may modify (not recommended) these permissions on the Conformance.deny() line.
* @memberof Server.Conformance
* @member Conformance
*/
export const Conformance = new ConformanceCollection('Conformance');
 ...
 * @see ./publications.js
 */
Conformance.publicFields = {};
Conformance.privateFields = {};
