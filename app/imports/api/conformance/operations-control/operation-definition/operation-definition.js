 ...
 */
class OperationDefinitionCollection extends Mongo.Collection {
    /**
     * @public
 ...
 * You may modify (not recommended) these permissions on the OperationDefinition.deny() line.
* @memberof Server.OperationDefinition
* @member OperationDefinition
*/
export const OperationDefinition = new OperationDefinitionCollection('OperationDefinition');

/**
 * Set the client side access rights to the Cases collection.
 * Default: Deny all
 */
OperationDefinition.deny({
    insert() { return true; },
    update() { return true; },
    remove() { return true; }
});
 ...
 * @see ./publications.js
 */
OperationDefinition.publicFields = {};
OperationDefinition.privateFields = {};
