 ...
 */
const insertValueSet = new ValidatedMethod({
    name: 'value-set.insert',
    validate: null,
    run(doc) {
        //return ValueSet.insert(doc);
    }
});
 ...
 * @property { function }   run         The main action that is executed.
 */
const updateValueSet  = new ValidatedMethod({
    name: 'value-set.update',
    validate: null,
    run([docId, obj]) {
        //return ValueSet.update(docId, {$set: obj});
    }
});
 ...
 * @property { function }   run         The main action that is executed.
 */
const removeValueSet  = new ValidatedMethod({
    name: 'value-set.remove',
    validate: null,
    run(docId) {
        //return ValueSet.remove(docId);
    }
});

const RATE_LIMITED_METHODS = _.pluck([
    insertValueSet , updateValueSet , removeValueSet
], 'name');
