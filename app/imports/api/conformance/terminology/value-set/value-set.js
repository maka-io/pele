 ...
 */
class ValueSetCollection extends Mongo.Collection {
    /**
     * @public
 ...
 * You may modify (not recommended) these permissions on the ValueSet.deny() line.
* @memberof Server.ValueSet
* @member ValueSet
*/
export const ValueSet = new ValueSetCollection('ValueSet');
 ...
 * @see ./publications.js
 */
ValueSet.publicFields = {};
ValueSet.privateFields = {};
