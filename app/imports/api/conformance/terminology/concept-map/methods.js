 ...
 */
const insertConceptMap = new ValidatedMethod({
    name: 'concept-map.insert',
    validate: null,
    run(doc) {
        //return ConceptMap.insert(doc);
    }
});
 ...
 * @property { function }   run         The main action that is executed.
 */
const updateConceptMap  = new ValidatedMethod({
    name: 'concept-map.update',
    validate: null,
    run([docId, obj]) {
        //return ConceptMap.update(docId, {$set: obj});
    }
});
 ...
 * @property { function }   run         The main action that is executed.
 */
const removeConceptMap  = new ValidatedMethod({
    name: 'concept-map.remove',
    validate: null,
    run(docId) {
        //return ConceptMap.remove(docId);
    }
});

const RATE_LIMITED_METHODS = _.pluck([
    insertConceptMap , updateConceptMap , removeConceptMap
], 'name');
