 ...
 */
class ConceptMapCollection extends Mongo.Collection {
    /**
     * @public
 ...
 * You may modify (not recommended) these permissions on the ConceptMap.deny() line.
* @memberof Server.ConceptMap
* @member ConceptMap
*/
export const ConceptMap = new ConceptMapCollection('ConceptMap');
 ...
 * @see ./publications.js
 */
ConceptMap.publicFields = {};
ConceptMap.privateFields = {};
