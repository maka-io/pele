 ...
 */
class NamingSystemCollection extends Mongo.Collection {
    /**
     * @public
 ...
 * You may modify (not recommended) these permissions on the NamingSystem.deny() line.
* @memberof Server.NamingSystem
* @member NamingSystem
*/
export const NamingSystem = new NamingSystemCollection('NamingSystem');
 ...
 * @see ./publications.js
 */
NamingSystem.publicFields = {};
NamingSystem.privateFields = {};
