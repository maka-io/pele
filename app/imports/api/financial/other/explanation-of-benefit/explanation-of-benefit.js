 ...
 */
class ExplanationOfBenefitCollection extends Mongo.Collection {
    /**
     * @public
 ...
 * You may modify (not recommended) these permissions on the ExplanationOfBenefit.deny() line.
* @memberof Server.ExplanationOfBenefit
* @member ExplanationOfBenefit
*/
export const ExplanationOfBenefit = new ExplanationOfBenefitCollection('ExplanationOfBenefit');

/**
 * Set the client side access rights to the Cases collection.
 * Default: Deny all
 */
ExplanationOfBenefit.deny({
    insert() { return true; },
    update() { return true; },
    remove() { return true; }
});
 ...
 * @see ./publications.js
 */
ExplanationOfBenefit.publicFields = {};
ExplanationOfBenefit.privateFields = {};
