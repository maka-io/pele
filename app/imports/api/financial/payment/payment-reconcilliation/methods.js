 ...
 */
const insertPaymentReconcilliation = new ValidatedMethod({
    name: 'payment-reconcilliation.insert',
    validate: null,
    run(doc) {
        //return PaymentReconcilliation.insert(doc);
    }
});
 ...
 * @property { function }   run         The main action that is executed.
 */
const updatePaymentReconcilliation  = new ValidatedMethod({
    name: 'payment-reconcilliation.update',
    validate: null,
    run([docId, obj]) {
        //return PaymentReconcilliation.update(docId, {$set: obj});
    }
});
 ...
 * @property { function }   run         The main action that is executed.
 */
const removePaymentReconcilliation  = new ValidatedMethod({
    name: 'payment-reconcilliation.remove',
    validate: null,
    run(docId) {
        //return PaymentReconcilliation.remove(docId);
    }
});

const RATE_LIMITED_METHODS = _.pluck([
    insertPaymentReconcilliation , updatePaymentReconcilliation , removePaymentReconcilliation
], 'name');
