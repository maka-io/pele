 ...
 */
class PaymentReconcilliationCollection extends Mongo.Collection {
    /**
     * @public
 ...
 * You may modify (not recommended) these permissions on the PaymentReconcilliation.deny() line.
* @memberof Server.PaymentReconcilliation
* @member PaymentReconcilliation
*/
export const PaymentReconcilliation = new PaymentReconcilliationCollection('PaymentReconcilliation');

/**
 * Set the client side access rights to the Cases collection.
 * Default: Deny all
 */
PaymentReconcilliation.deny({
    insert() { return true; },
    update() { return true; },
    remove() { return true; }
});
 ...
 * @see ./publications.js
 */
PaymentReconcilliation.publicFields = {};
PaymentReconcilliation.privateFields = {};
