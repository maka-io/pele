 ...
 */
const insertPaymentNotice = new ValidatedMethod({
    name: 'payment-notice.insert',
    validate: null,
    run(doc) {
        //return PaymentNotice.insert(doc);
    }
});
 ...
 * @property { function }   run         The main action that is executed.
 */
const updatePaymentNotice  = new ValidatedMethod({
    name: 'payment-notice.update',
    validate: null,
    run([docId, obj]) {
        //return PaymentNotice.update(docId, {$set: obj});
    }
});
 ...
 * @property { function }   run         The main action that is executed.
 */
const removePaymentNotice  = new ValidatedMethod({
    name: 'payment-notice.remove',
    validate: null,
    run(docId) {
        //return PaymentNotice.remove(docId);
    }
});

const RATE_LIMITED_METHODS = _.pluck([
    insertPaymentNotice , updatePaymentNotice , removePaymentNotice
], 'name');
