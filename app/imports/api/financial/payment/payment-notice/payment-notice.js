 ...
 */
class PaymentNoticeCollection extends Mongo.Collection {
    /**
     * @public
 ...
 * You may modify (not recommended) these permissions on the PaymentNotice.deny() line.
* @memberof Server.PaymentNotice
* @member PaymentNotice
*/
export const PaymentNotice = new PaymentNoticeCollection('PaymentNotice');
 ...
 * @see ./publications.js
 */
PaymentNotice.publicFields = {};
PaymentNotice.privateFields = {};
