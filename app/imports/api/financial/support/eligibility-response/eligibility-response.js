 ...
 */
class EligibilityResponseCollection extends Mongo.Collection {
    /**
     * @public
 ...
 * You may modify (not recommended) these permissions on the EligibilityResponse.deny() line.
* @memberof Server.EligibilityResponse
* @member EligibilityResponse
*/
export const EligibilityResponse = new EligibilityResponseCollection('EligibilityResponse');

/**
 * Set the client side access rights to the Cases collection.
 * Default: Deny all
 */
EligibilityResponse.deny({
    insert() { return true; },
    update() { return true; },
    remove() { return true; }
});
 ...
 * @see ./publications.js
 */
EligibilityResponse.publicFields = {};
EligibilityResponse.privateFields = {};
