 ...
 */
const insertEligibilityResponse = new ValidatedMethod({
    name: 'eligibility-response.insert',
    validate: null,
    run(doc) {
        //return EligibilityResponse.insert(doc);
    }
});
 ...
 * @property { function }   run         The main action that is executed.
 */
const updateEligibilityResponse  = new ValidatedMethod({
    name: 'eligibility-response.update',
    validate: null,
    run([docId, obj]) {
        //return EligibilityResponse.update(docId, {$set: obj});
    }
});
 ...
 * @property { function }   run         The main action that is executed.
 */
const removeEligibilityResponse  = new ValidatedMethod({
    name: 'eligibility-response.remove',
    validate: null,
    run(docId) {
        //return EligibilityResponse.remove(docId);
    }
});

const RATE_LIMITED_METHODS = _.pluck([
    insertEligibilityResponse , updateEligibilityResponse , removeEligibilityResponse
], 'name');
