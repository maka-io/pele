 ...
 */
const insertCoverage = new ValidatedMethod({
    name: 'coverage.insert',
    validate: null,
    run(doc) {
        //return Coverage.insert(doc);
    }
});
 ...
 * @property { function }   run         The main action that is executed.
 */
const updateCoverage  = new ValidatedMethod({
    name: 'coverage.update',
    validate: null,
    run([docId, obj]) {
        //return Coverage.update(docId, {$set: obj});
    }
});
 ...
 * @property { function }   run         The main action that is executed.
 */
const removeCoverage  = new ValidatedMethod({
    name: 'coverage.remove',
    validate: null,
    run(docId) {
        //return Coverage.remove(docId);
    }
});

const RATE_LIMITED_METHODS = _.pluck([
    insertCoverage , updateCoverage , removeCoverage
], 'name');
