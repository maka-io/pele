 ...
 */
class CoverageCollection extends Mongo.Collection {
    /**
     * @public
 ...
 * You may modify (not recommended) these permissions on the Coverage.deny() line.
* @memberof Server.Coverage
* @member Coverage
*/
export const Coverage = new CoverageCollection('Coverage');
 ...
 * @see ./publications.js
 */
Coverage.publicFields = {};
Coverage.privateFields = {};
