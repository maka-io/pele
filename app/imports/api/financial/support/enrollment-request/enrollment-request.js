 ...
 */
class EnrollmentRequestCollection extends Mongo.Collection {
    /**
     * @public
 ...
 * You may modify (not recommended) these permissions on the EnrollmentRequest.deny() line.
* @memberof Server.EnrollmentRequest
* @member EnrollmentRequest
*/
export const EnrollmentRequest = new EnrollmentRequestCollection('EnrollmentRequest');
 ...
 * @see ./publications.js
 */
EnrollmentRequest.publicFields = {};
EnrollmentRequest.privateFields = {};
