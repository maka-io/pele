 ...
 */
const insertEligibilityRequest = new ValidatedMethod({
    name: 'eligibility-request.insert',
    validate: null,
    run(doc) {
        //return EligibilityRequest.insert(doc);
    }
});
 ...
 * @property { function }   run         The main action that is executed.
 */
const updateEligibilityRequest  = new ValidatedMethod({
    name: 'eligibility-request.update',
    validate: null,
    run([docId, obj]) {
        //return EligibilityRequest.update(docId, {$set: obj});
    }
});
 ...
 * @property { function }   run         The main action that is executed.
 */
const removeEligibilityRequest  = new ValidatedMethod({
    name: 'eligibility-request.remove',
    validate: null,
    run(docId) {
        //return EligibilityRequest.remove(docId);
    }
});

const RATE_LIMITED_METHODS = _.pluck([
    insertEligibilityRequest , updateEligibilityRequest , removeEligibilityRequest
], 'name');
