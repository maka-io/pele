 ...
 */
class EligibilityRequestCollection extends Mongo.Collection {
    /**
     * @public
 ...
 * You may modify (not recommended) these permissions on the EligibilityRequest.deny() line.
* @memberof Server.EligibilityRequest
* @member EligibilityRequest
*/
export const EligibilityRequest = new EligibilityRequestCollection('EligibilityRequest');

/**
 * Set the client side access rights to the Cases collection.
 * Default: Deny all
 */
EligibilityRequest.deny({
    insert() { return true; },
    update() { return true; },
    remove() { return true; }
});
 ...
 * @see ./publications.js
 */
EligibilityRequest.publicFields = {};
EligibilityRequest.privateFields = {};
