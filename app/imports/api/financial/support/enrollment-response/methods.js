 ...
 */
const insertEnrollmentResponse = new ValidatedMethod({
    name: 'enrollment-response.insert',
    validate: null,
    run(doc) {
        //return EnrollmentResponse.insert(doc);
    }
});
 ...
 * @property { function }   run         The main action that is executed.
 */
const updateEnrollmentResponse  = new ValidatedMethod({
    name: 'enrollment-response.update',
    validate: null,
    run([docId, obj]) {
        //return EnrollmentResponse.update(docId, {$set: obj});
    }
});
 ...
 * @property { function }   run         The main action that is executed.
 */
const removeEnrollmentResponse  = new ValidatedMethod({
    name: 'enrollment-response.remove',
    validate: null,
    run(docId) {
        //return EnrollmentResponse.remove(docId);
    }
});

const RATE_LIMITED_METHODS = _.pluck([
    insertEnrollmentResponse , updateEnrollmentResponse , removeEnrollmentResponse
], 'name');
