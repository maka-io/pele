 ...
 */
class EnrollmentResponseCollection extends Mongo.Collection {
    /**
     * @public
 ...
 * You may modify (not recommended) these permissions on the EnrollmentResponse.deny() line.
* @memberof Server.EnrollmentResponse
* @member EnrollmentResponse
*/
export const EnrollmentResponse = new EnrollmentResponseCollection('EnrollmentResponse');

/**
 * Set the client side access rights to the Cases collection.
 * Default: Deny all
 */
EnrollmentResponse.deny({
    insert() { return true; },
    update() { return true; },
    remove() { return true; }
});
 ...
 * @see ./publications.js
 */
EnrollmentResponse.publicFields = {};
EnrollmentResponse.privateFields = {};
