 ...
 */
class ClaimCollection extends Mongo.Collection {
    /**
     * @public
 ...
 * You may modify (not recommended) these permissions on the Claim.deny() line.
* @memberof Server.Claim
* @member Claim
*/
export const Claim = new ClaimCollection('Claim');
