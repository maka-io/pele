 ...
 */
const insertClaimResponse = new ValidatedMethod({
    name: 'claim-response.insert',
    validate: null,
    run(doc) {
        //return ClaimResponse.insert(doc);
    }
});
 ...
 * @property { function }   run         The main action that is executed.
 */
const updateClaimResponse  = new ValidatedMethod({
    name: 'claim-response.update',
    validate: null,
    run([docId, obj]) {
        //return ClaimResponse.update(docId, {$set: obj});
    }
});
 ...
 * @property { function }   run         The main action that is executed.
 */
const removeClaimResponse  = new ValidatedMethod({
    name: 'claim-response.remove',
    validate: null,
    run(docId) {
        //return ClaimResponse.remove(docId);
    }
});

const RATE_LIMITED_METHODS = _.pluck([
    insertClaimResponse , updateClaimResponse , removeClaimResponse
], 'name');
