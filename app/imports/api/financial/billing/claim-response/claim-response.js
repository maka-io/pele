 ...
 */
class ClaimResponseCollection extends Mongo.Collection {
    /**
     * @public
 ...
 * You may modify (not recommended) these permissions on the ClaimResponse.deny() line.
* @memberof Server.ClaimResponse
* @member ClaimResponse
*/
export const ClaimResponse = new ClaimResponseCollection('ClaimResponse');
 ...
 * @see ./publications.js
 */
ClaimResponse.publicFields = {};
ClaimResponse.privateFields = {};
