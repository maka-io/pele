 ...
 */
class BodySiteCollection extends Mongo.Collection {
    /**
     * @public
 ...
 * You may modify (not recommended) these permissions on the BodySite.deny() line.
* @memberof Server.BodySite
* @member BodySite
*/
export const BodySite = new BodySiteCollection('BodySite');
 ...
 * @see ./publications.js
 */
BodySite.publicFields = {};
BodySite.privateFields = {};
