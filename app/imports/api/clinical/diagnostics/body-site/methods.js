 ...
 */
const insertBodySite = new ValidatedMethod({
    name: 'body-site.insert',
    validate: null,
    run(doc) {
        //return BodySite.insert(doc);
    }
});
 ...
 * @property { function }   run         The main action that is executed.
 */
const updateBodySite  = new ValidatedMethod({
    name: 'body-site.update',
    validate: null,
    run([docId, obj]) {
        //return BodySite.update(docId, {$set: obj});
    }
});
 ...
 * @property { function }   run         The main action that is executed.
 */
const removeBodySite  = new ValidatedMethod({
    name: 'body-site.remove',
    validate: null,
    run(docId) {
        //return BodySite.remove(docId);
    }
});

const RATE_LIMITED_METHODS = _.pluck([
    insertBodySite , updateBodySite , removeBodySite
], 'name');
