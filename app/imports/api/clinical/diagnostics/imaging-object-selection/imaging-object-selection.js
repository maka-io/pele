 ...
 */
class ImagingObjectSelectionCollection extends Mongo.Collection {
    /**
     * @public
 ...
 * You may modify (not recommended) these permissions on the ImagingObjectSelection.deny() line.
* @memberof Server.ImagingObjectSelection
* @member ImagingObjectSelection
*/
export const ImagingObjectSelection = new ImagingObjectSelectionCollection('ImagingObjectSelection');

/**
 * Set the client side access rights to the Cases collection.
 * Default: Deny all
 */
ImagingObjectSelection.deny({
    insert() { return true; },
    update() { return true; },
    remove() { return true; }
});
 ...
 * @see ./publications.js
 */
ImagingObjectSelection.publicFields = {};
ImagingObjectSelection.privateFields = {};
