 ...
 */
class DiagnosticOrderCollection extends Mongo.Collection {
    /**
     * @public
 ...
 * You may modify (not recommended) these permissions on the DiagnosticOrder.deny() line.
* @memberof Server.DiagnosticOrder
* @member DiagnosticOrder
*/
export const DiagnosticOrder = new DiagnosticOrderCollection('DiagnosticOrder');

/**
 * Set the client side access rights to the Cases collection.
 * Default: Deny all
 */
DiagnosticOrder.deny({
    insert() { return true; },
    update() { return true; },
    remove() { return true; }
});
 ...
 * @see ./publications.js
 */
DiagnosticOrder.publicFields = {};
DiagnosticOrder.privateFields = {};
