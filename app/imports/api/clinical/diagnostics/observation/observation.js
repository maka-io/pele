 ...
 */
class ObservationCollection extends Mongo.Collection {
    /**
     * @public
 ...
 * You may modify (not recommended) these permissions on the Observation.deny() line.
* @memberof Server.Observation
* @member Observation
*/
export const Observation = new ObservationCollection('Observation');
 ...
 * @see ./publications.js
 */
Observation.publicFields = {};
Observation.privateFields = {};
