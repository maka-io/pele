 ...
 */
const insertDiagnosticReport = new ValidatedMethod({
    name: 'diagnostic-report.insert',
    validate: null,
    run(doc) {
        //return DiagnosticReport.insert(doc);
    }
});
 ...
 * @property { function }   run         The main action that is executed.
 */
const updateDiagnosticReport  = new ValidatedMethod({
    name: 'diagnostic-report.update',
    validate: null,
    run([docId, obj]) {
        //return DiagnosticReport.update(docId, {$set: obj});
    }
});
 ...
 * @property { function }   run         The main action that is executed.
 */
const removeDiagnosticReport  = new ValidatedMethod({
    name: 'diagnostic-report.remove',
    validate: null,
    run(docId) {
        //return DiagnosticReport.remove(docId);
    }
});

const RATE_LIMITED_METHODS = _.pluck([
    insertDiagnosticReport , updateDiagnosticReport , removeDiagnosticReport
], 'name');
