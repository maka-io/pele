 ...
 */
class DiagnosticReportCollection extends Mongo.Collection {
    /**
     * @public
 ...
 * You may modify (not recommended) these permissions on the DiagnosticReport.deny() line.
* @memberof Server.DiagnosticReport
* @member DiagnosticReport
*/
export const DiagnosticReport = new DiagnosticReportCollection('DiagnosticReport');

/**
 * Set the client side access rights to the Cases collection.
 * Default: Deny all
 */
DiagnosticReport.deny({
    insert() { return true; },
    update() { return true; },
    remove() { return true; }
});
 ...
 * @see ./publications.js
 */
DiagnosticReport.publicFields = {};
DiagnosticReport.privateFields = {};
