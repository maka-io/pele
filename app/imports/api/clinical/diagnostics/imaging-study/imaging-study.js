 ...
 */
class ImagingStudyCollection extends Mongo.Collection {
    /**
     * @public
 ...
 * You may modify (not recommended) these permissions on the ImagingStudy.deny() line.
* @memberof Server.ImagingStudy
* @member ImagingStudy
*/
export const ImagingStudy = new ImagingStudyCollection('ImagingStudy');
 ...
 * @see ./publications.js
 */
ImagingStudy.publicFields = {};
ImagingStudy.privateFields = {};
