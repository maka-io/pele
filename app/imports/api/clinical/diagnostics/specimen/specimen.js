 ...
 */
class SpecimenCollection extends Mongo.Collection {
    /**
     * @public
 ...
 * You may modify (not recommended) these permissions on the Specimen.deny() line.
* @memberof Server.Specimen
* @member Specimen
*/
export const Specimen = new SpecimenCollection('Specimen');
 ...
 * @see ./publications.js
 */
Specimen.publicFields = {};
Specimen.privateFields = {};
