 ...
 */
const insertSpecimen = new ValidatedMethod({
    name: 'specimen.insert',
    validate: null,
    run(doc) {
        //return Specimen.insert(doc);
    }
});
 ...
 * @property { function }   run         The main action that is executed.
 */
const updateSpecimen  = new ValidatedMethod({
    name: 'specimen.update',
    validate: null,
    run([docId, obj]) {
        //return Specimen.update(docId, {$set: obj});
    }
});
 ...
 * @property { function }   run         The main action that is executed.
 */
const removeSpecimen  = new ValidatedMethod({
    name: 'specimen.remove',
    validate: null,
    run(docId) {
        //return Specimen.remove(docId);
    }
});

const RATE_LIMITED_METHODS = _.pluck([
    insertSpecimen , updateSpecimen , removeSpecimen
], 'name');
