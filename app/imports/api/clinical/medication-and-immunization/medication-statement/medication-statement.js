 ...
 */
class MedicationStatementCollection extends Mongo.Collection {
    /**
     * @public
 ...
 * You may modify (not recommended) these permissions on the MedicationStatement.deny() line.
* @memberof Server.MedicationStatement
* @member MedicationStatement
*/
export const MedicationStatement = new MedicationStatementCollection('MedicationStatement');

/**
 * Set the client side access rights to the Cases collection.
 * Default: Deny all
 */
MedicationStatement.deny({
    insert() { return true; },
    update() { return true; },
    remove() { return true; }
});
 ...
 * @see ./publications.js
 */
MedicationStatement.publicFields = {};
MedicationStatement.privateFields = {};
