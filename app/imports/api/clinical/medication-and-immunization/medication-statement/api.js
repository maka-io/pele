 ...
 */
const MedicationStatementApiV1 = new Restivus({
    version: 'v1',
    useDefaultAuth: true,
...
// Uncommenting below will expose ALL routes for MedicationStatement
//
// Please review restivus documentation on how to harden endpoints.
//
// USE WITH CAUTION... can you imagine - $ maka g:api BankRecords
MedicationStatementApiV1.addCollection(MedicationStatement);
