 ...
 */
const insertMedicationStatement = new ValidatedMethod({
    name: 'medication-statement.insert',
    validate: null,
    run(doc) {
        //return MedicationStatement.insert(doc);
    }
});
 ...
 * @property { function }   run         The main action that is executed.
 */
const updateMedicationStatement  = new ValidatedMethod({
    name: 'medication-statement.update',
    validate: null,
    run([docId, obj]) {
        //return MedicationStatement.update(docId, {$set: obj});
    }
});
 ...
 * @property { function }   run         The main action that is executed.
 */
const removeMedicationStatement  = new ValidatedMethod({
    name: 'medication-statement.remove',
    validate: null,
    run(docId) {
        //return MedicationStatement.remove(docId);
    }
});

const RATE_LIMITED_METHODS = _.pluck([
    insertMedicationStatement , updateMedicationStatement , removeMedicationStatement
], 'name');
