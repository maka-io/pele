 ...
 */
class MedicationDispenseCollection extends Mongo.Collection {
    /**
     * @public
 ...
 * You may modify (not recommended) these permissions on the MedicationDispense.deny() line.
* @memberof Server.MedicationDispense
* @member MedicationDispense
*/
export const MedicationDispense = new MedicationDispenseCollection('MedicationDispense');

/**
 * Set the client side access rights to the Cases collection.
 * Default: Deny all
 */
MedicationDispense.deny({
    insert() { return true; },
    update() { return true; },
    remove() { return true; }
});
 ...
 * @see ./publications.js
 */
MedicationDispense.publicFields = {};
MedicationDispense.privateFields = {};
