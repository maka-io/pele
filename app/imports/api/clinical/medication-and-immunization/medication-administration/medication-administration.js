 ...
 */
class MedicationAdministrationCollection extends Mongo.Collection {
    /**
     * @public
 ...
 * You may modify (not recommended) these permissions on the MedicationAdministration.deny() line.
* @memberof Server.MedicationAdministration
* @member MedicationAdministration
*/
export const MedicationAdministration = new MedicationAdministrationCollection('MedicationAdministration');

/**
 * Set the client side access rights to the Cases collection.
 * Default: Deny all
 */
MedicationAdministration.deny({
    insert() { return true; },
    update() { return true; },
    remove() { return true; }
});
 ...
 * @see ./publications.js
 */
MedicationAdministration.publicFields = {};
MedicationAdministration.privateFields = {};
