 ...
 */
const MedicationAdministrationApiV1 = new Restivus({
    version: 'v1',
    useDefaultAuth: true,
...
// Uncommenting below will expose ALL routes for MedicationAdministration
//
// Please review restivus documentation on how to harden endpoints.
//
// USE WITH CAUTION... can you imagine - $ maka g:api BankRecords
// MedicationAdministrationApiV1.addCollection(MedicationAdministration);
