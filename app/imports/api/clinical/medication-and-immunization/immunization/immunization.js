 ...
 */
class ImmunizationCollection extends Mongo.Collection {
    /**
     * @public
 ...
 * You may modify (not recommended) these permissions on the Immunization.deny() line.
* @memberof Server.Immunization
* @member Immunization
*/
export const Immunization = new ImmunizationCollection('Immunization');
 ...
 * @see ./publications.js
 */
Immunization.publicFields = {};
Immunization.privateFields = {};
