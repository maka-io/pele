 ...
 */
const insertImmunization = new ValidatedMethod({
    name: 'immunization.insert',
    validate: null,
    run(doc) {
        //return Immunization.insert(doc);
    }
});
 ...
 * @property { function }   run         The main action that is executed.
 */
const updateImmunization  = new ValidatedMethod({
    name: 'immunization.update',
    validate: null,
    run([docId, obj]) {
        //return Immunization.update(docId, {$set: obj});
    }
});
 ...
 * @property { function }   run         The main action that is executed.
 */
const removeImmunization  = new ValidatedMethod({
    name: 'immunization.remove',
    validate: null,
    run(docId) {
        //return Immunization.remove(docId);
    }
});

const RATE_LIMITED_METHODS = _.pluck([
    insertImmunization , updateImmunization , removeImmunization
], 'name');
