 ...
 */
class MedicationOrderCollection extends Mongo.Collection {
    /**
     * @public
 ...
 * You may modify (not recommended) these permissions on the MedicationOrder.deny() line.
* @memberof Server.MedicationOrder
* @member MedicationOrder
*/
export const MedicationOrder = new MedicationOrderCollection('MedicationOrder');

/**
 * Set the client side access rights to the Cases collection.
 * Default: Deny all
 */
MedicationOrder.deny({
    insert() { return true; },
    update() { return true; },
    remove() { return true; }
});
 ...
 * @see ./publications.js
 */
MedicationOrder.publicFields = {};
MedicationOrder.privateFields = {};
