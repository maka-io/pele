 ...
 */
class ImmunizationRecommendationCollection extends Mongo.Collection {
    /**
     * @public
 ...
 * You may modify (not recommended) these permissions on the ImmunizationRecommendation.deny() line.
* @memberof Server.ImmunizationRecommendation
* @member ImmunizationRecommendation
*/
export const ImmunizationRecommendation = new ImmunizationRecommendationCollection('ImmunizationRecommendation');

/**
 * Set the client side access rights to the Cases collection.
 * Default: Deny all
 */
ImmunizationRecommendation.deny({
    insert() { return true; },
    update() { return true; },
    remove() { return true; }
});
 ...
 * @see ./publications.js
 */
ImmunizationRecommendation.publicFields = {};
ImmunizationRecommendation.privateFields = {};
