 ...
 */
const insertMedication = new ValidatedMethod({
    name: 'medication.insert',
    validate: null,
    run(doc) {
        //return Medication.insert(doc);
    }
});
 ...
 * @property { function }   run         The main action that is executed.
 */
const updateMedication  = new ValidatedMethod({
    name: 'medication.update',
    validate: null,
    run([docId, obj]) {
        //return Medication.update(docId, {$set: obj});
    }
});
 ...
 * @property { function }   run         The main action that is executed.
 */
const removeMedication  = new ValidatedMethod({
    name: 'medication.remove',
    validate: null,
    run(docId) {
        //return Medication.remove(docId);
    }
});

const RATE_LIMITED_METHODS = _.pluck([
    insertMedication , updateMedication , removeMedication
], 'name');
