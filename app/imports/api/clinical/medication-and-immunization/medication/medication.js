 ...
 */
class MedicationCollection extends Mongo.Collection {
    /**
     * @public
 ...
 * You may modify (not recommended) these permissions on the Medication.deny() line.
* @memberof Server.Medication
* @member Medication
*/
export const Medication = new MedicationCollection('Medication');
 ...
 * @see ./publications.js
 */
Medication.publicFields = {};
Medication.privateFields = {};
