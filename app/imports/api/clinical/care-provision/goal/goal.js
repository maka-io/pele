 ...
 */
class GoalCollection extends Mongo.Collection {
    /**
     * @public
 ...
 * You may modify (not recommended) these permissions on the Goal.deny() line.
* @memberof Server.Goal
* @member Goal
*/
export const Goal = new GoalCollection('Goal');
