 ...
 */
class NutritionOrderCollection extends Mongo.Collection {
    /**
     * @public
 ...
 * You may modify (not recommended) these permissions on the NutritionOrder.deny() line.
* @memberof Server.NutritionOrder
* @member NutritionOrder
*/
export const NutritionOrder = new NutritionOrderCollection('NutritionOrder');
 ...
 * @see ./publications.js
 */
NutritionOrder.publicFields = {};
NutritionOrder.privateFields = {};
