 ...
 */
const insertVisionPrescription = new ValidatedMethod({
    name: 'vision-prescription.insert',
    validate: null,
    run(doc) {
        //return VisionPrescription.insert(doc);
    }
});
 ...
 * @property { function }   run         The main action that is executed.
 */
const updateVisionPrescription  = new ValidatedMethod({
    name: 'vision-prescription.update',
    validate: null,
    run([docId, obj]) {
        //return VisionPrescription.update(docId, {$set: obj});
    }
});
 ...
 * @property { function }   run         The main action that is executed.
 */
const removeVisionPrescription  = new ValidatedMethod({
    name: 'vision-prescription.remove',
    validate: null,
    run(docId) {
        //return VisionPrescription.remove(docId);
    }
});

const RATE_LIMITED_METHODS = _.pluck([
    insertVisionPrescription , updateVisionPrescription , removeVisionPrescription
], 'name');
