 ...
 */
class VisionPrescriptionCollection extends Mongo.Collection {
    /**
     * @public
 ...
 * You may modify (not recommended) these permissions on the VisionPrescription.deny() line.
* @memberof Server.VisionPrescription
* @member VisionPrescription
*/
export const VisionPrescription = new VisionPrescriptionCollection('VisionPrescription');

/**
 * Set the client side access rights to the Cases collection.
 * Default: Deny all
 */
VisionPrescription.deny({
    insert() { return true; },
    update() { return true; },
    remove() { return true; }
});
 ...
 * @see ./publications.js
 */
VisionPrescription.publicFields = {};
VisionPrescription.privateFields = {};
