 ...
 */
class ReferralRequestCollection extends Mongo.Collection {
    /**
     * @public
 ...
 * You may modify (not recommended) these permissions on the ReferralRequest.deny() line.
* @memberof Server.ReferralRequest
* @member ReferralRequest
*/
export const ReferralRequest = new ReferralRequestCollection('ReferralRequest');

/**
 * Set the client side access rights to the Cases collection.
 * Default: Deny all
 */
ReferralRequest.deny({
    insert() { return true; },
    update() { return true; },
    remove() { return true; }
});
 ...
 * @see ./publications.js
 */
ReferralRequest.publicFields = {};
ReferralRequest.privateFields = {};
