 ...
 */
const insertReferralRequest = new ValidatedMethod({
    name: 'referral-request.insert',
    validate: null,
    run(doc) {
        //return ReferralRequest.insert(doc);
    }
});
 ...
 * @property { function }   run         The main action that is executed.
 */
const updateReferralRequest  = new ValidatedMethod({
    name: 'referral-request.update',
    validate: null,
    run([docId, obj]) {
        //return ReferralRequest.update(docId, {$set: obj});
    }
});
 ...
 * @property { function }   run         The main action that is executed.
 */
const removeReferralRequest  = new ValidatedMethod({
    name: 'referral-request.remove',
    validate: null,
    run(docId) {
        //return ReferralRequest.remove(docId);
    }
});

const RATE_LIMITED_METHODS = _.pluck([
    insertReferralRequest , updateReferralRequest , removeReferralRequest
], 'name');
