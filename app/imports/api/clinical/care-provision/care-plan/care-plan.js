 ...
 */
class CarePlanCollection extends Mongo.Collection {
    /**
     * @public
 ...
 * You may modify (not recommended) these permissions on the CarePlan.deny() line.
* @memberof Server.CarePlan
* @member CarePlan
*/
export const CarePlan = new CarePlanCollection('CarePlan');
 ...
 * @see ./publications.js
 */
CarePlan.publicFields = {};
CarePlan.privateFields = {};
