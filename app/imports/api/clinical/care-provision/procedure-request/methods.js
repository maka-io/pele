 ...
 */
const insertProcedureRequest = new ValidatedMethod({
    name: 'procedure-request.insert',
    validate: null,
    run(doc) {
        //return ProcedureRequest.insert(doc);
    }
});
 ...
 * @property { function }   run         The main action that is executed.
 */
const updateProcedureRequest  = new ValidatedMethod({
    name: 'procedure-request.update',
    validate: null,
    run([docId, obj]) {
        //return ProcedureRequest.update(docId, {$set: obj});
    }
});
 ...
 * @property { function }   run         The main action that is executed.
 */
const removeProcedureRequest  = new ValidatedMethod({
    name: 'procedure-request.remove',
    validate: null,
    run(docId) {
        //return ProcedureRequest.remove(docId);
    }
});

const RATE_LIMITED_METHODS = _.pluck([
    insertProcedureRequest , updateProcedureRequest , removeProcedureRequest
], 'name');
