 ...
 */
class ProcedureRequestCollection extends Mongo.Collection {
    /**
     * @public
 ...
 * You may modify (not recommended) these permissions on the ProcedureRequest.deny() line.
* @memberof Server.ProcedureRequest
* @member ProcedureRequest
*/
export const ProcedureRequest = new ProcedureRequestCollection('ProcedureRequest');

/**
 * Set the client side access rights to the Cases collection.
 * Default: Deny all
 */
ProcedureRequest.deny({
    insert() { return true; },
    update() { return true; },
    remove() { return true; }
});
 ...
 * @see ./publications.js
 */
ProcedureRequest.publicFields = {};
ProcedureRequest.privateFields = {};
