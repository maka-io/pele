 ...
 */
const insertClinicalImpression = new ValidatedMethod({
    name: 'clinical-impression.insert',
    validate: null,
    run(doc) {
        //return ClinicalImpression.insert(doc);
    }
});
 ...
 * @property { function }   run         The main action that is executed.
 */
const updateClinicalImpression  = new ValidatedMethod({
    name: 'clinical-impression.update',
    validate: null,
    run([docId, obj]) {
        //return ClinicalImpression.update(docId, {$set: obj});
    }
});
 ...
 * @property { function }   run         The main action that is executed.
 */
const removeClinicalImpression  = new ValidatedMethod({
    name: 'clinical-impression.remove',
    validate: null,
    run(docId) {
        //return ClinicalImpression.remove(docId);
    }
});

const RATE_LIMITED_METHODS = _.pluck([
    insertClinicalImpression , updateClinicalImpression , removeClinicalImpression
], 'name');
