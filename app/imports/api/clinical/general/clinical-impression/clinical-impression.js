 ...
 */
class ClinicalImpressionCollection extends Mongo.Collection {
    /**
     * @public
 ...
 * You may modify (not recommended) these permissions on the ClinicalImpression.deny() line.
* @memberof Server.ClinicalImpression
* @member ClinicalImpression
*/
export const ClinicalImpression = new ClinicalImpressionCollection('ClinicalImpression');

/**
 * Set the client side access rights to the Cases collection.
 * Default: Deny all
 */
ClinicalImpression.deny({
    insert() { return true; },
    update() { return true; },
    remove() { return true; }
});
 ...
 * @see ./publications.js
 */
ClinicalImpression.publicFields = {};
ClinicalImpression.privateFields = {};
