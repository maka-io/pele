 ...
 */
class RiskAssessmentCollection extends Mongo.Collection {
    /**
     * @public
 ...
 * You may modify (not recommended) these permissions on the RiskAssessment.deny() line.
* @memberof Server.RiskAssessment
* @member RiskAssessment
*/
export const RiskAssessment = new RiskAssessmentCollection('RiskAssessment');
 ...
 * @see ./publications.js
 */
RiskAssessment.publicFields = {};
RiskAssessment.privateFields = {};
