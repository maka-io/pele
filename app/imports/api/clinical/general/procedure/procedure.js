 ...
 */
class ProcedureCollection extends Mongo.Collection {
    /**
     * @public
 ...
 * You may modify (not recommended) these permissions on the Procedure.deny() line.
* @memberof Server.Procedure
* @member Procedure
*/
export const Procedure = new ProcedureCollection('Procedure');
 ...
 * @see ./publications.js
 */
Procedure.publicFields = {};
Procedure.privateFields = {};
