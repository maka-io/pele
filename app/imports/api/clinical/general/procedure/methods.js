 ...
 */
const insertProcedure = new ValidatedMethod({
    name: 'procedure.insert',
    validate: null,
    run(doc) {
        //return Procedure.insert(doc);
    }
});
 ...
 * @property { function }   run         The main action that is executed.
 */
const updateProcedure  = new ValidatedMethod({
    name: 'procedure.update',
    validate: null,
    run([docId, obj]) {
        //return Procedure.update(docId, {$set: obj});
    }
});
 ...
 * @property { function }   run         The main action that is executed.
 */
const removeProcedure  = new ValidatedMethod({
    name: 'procedure.remove',
    validate: null,
    run(docId) {
        //return Procedure.remove(docId);
    }
});

const RATE_LIMITED_METHODS = _.pluck([
    insertProcedure , updateProcedure , removeProcedure
], 'name');
