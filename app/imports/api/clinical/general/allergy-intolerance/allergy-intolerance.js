 ...
 */
class AllergyIntoleranceCollection extends Mongo.Collection {
    /**
     * @public
 ...
 * You may modify (not recommended) these permissions on the AllergyIntolerance.deny() line.
* @memberof Server.AllergyIntolerance
* @member AllergyIntolerance
*/
export const AllergyIntolerance = new AllergyIntoleranceCollection('AllergyIntolerance');

/**
 * Set the client side access rights to the Cases collection.
 * Default: Deny all
 */
AllergyIntolerance.deny({
    insert() { return true; },
    update() { return true; },
    remove() { return true; }
});
 ...
 * @see ./publications.js
 */
AllergyIntolerance.publicFields = {};
AllergyIntolerance.privateFields = {};
