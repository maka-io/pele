 ...
 */
const insertAllergyIntolerance = new ValidatedMethod({
    name: 'allergy-intolerance.insert',
    validate: null,
    run(doc) {
        //return AllergyIntolerance.insert(doc);
    }
});
 ...
 * @property { function }   run         The main action that is executed.
 */
const updateAllergyIntolerance  = new ValidatedMethod({
    name: 'allergy-intolerance.update',
    validate: null,
    run([docId, obj]) {
        //return AllergyIntolerance.update(docId, {$set: obj});
    }
});
 ...
 * @property { function }   run         The main action that is executed.
 */
const removeAllergyIntolerance  = new ValidatedMethod({
    name: 'allergy-intolerance.remove',
    validate: null,
    run(docId) {
        //return AllergyIntolerance.remove(docId);
    }
});

const RATE_LIMITED_METHODS = _.pluck([
    insertAllergyIntolerance , updateAllergyIntolerance , removeAllergyIntolerance
], 'name');
