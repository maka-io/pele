 ...
 */
class FamilyMemberHistoryCollection extends Mongo.Collection {
    /**
     * @public
 ...
 * You may modify (not recommended) these permissions on the FamilyMemberHistory.deny() line.
* @memberof Server.FamilyMemberHistory
* @member FamilyMemberHistory
*/
export const FamilyMemberHistory = new FamilyMemberHistoryCollection('FamilyMemberHistory');

/**
 * Set the client side access rights to the Cases collection.
 * Default: Deny all
 */
FamilyMemberHistory.deny({
    insert() { return true; },
    update() { return true; },
    remove() { return true; }
});
 ...
 * @see ./publications.js
 */
FamilyMemberHistory.publicFields = {};
FamilyMemberHistory.privateFields = {};
