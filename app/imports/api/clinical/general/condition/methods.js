 ...
 */
const insertCondition = new ValidatedMethod({
    name: 'condition.insert',
    validate: null,
    run(doc) {
        //return Condition.insert(doc);
    }
});
 ...
 * @property { function }   run         The main action that is executed.
 */
const updateCondition  = new ValidatedMethod({
    name: 'condition.update',
    validate: null,
    run([docId, obj]) {
        //return Condition.update(docId, {$set: obj});
    }
});
 ...
 * @property { function }   run         The main action that is executed.
 */
const removeCondition  = new ValidatedMethod({
    name: 'condition.remove',
    validate: null,
    run(docId) {
        //return Condition.remove(docId);
    }
});

const RATE_LIMITED_METHODS = _.pluck([
    insertCondition , updateCondition , removeCondition
], 'name');
