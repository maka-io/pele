 ...
 */
class DetectedIssueCollection extends Mongo.Collection {
    /**
     * @public
 ...
 * You may modify (not recommended) these permissions on the DetectedIssue.deny() line.
* @memberof Server.DetectedIssue
* @member DetectedIssue
*/
export const DetectedIssue = new DetectedIssueCollection('DetectedIssue');
 ...
 * @see ./publications.js
 */
DetectedIssue.publicFields = {};
DetectedIssue.privateFields = {};
