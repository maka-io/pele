 ...
 */
const insertList = new ValidatedMethod({
    name: 'list.insert',
    validate: null,
    run(doc) {
        //return List.insert(doc);
    }
});
 ...
 * @property { function }   run         The main action that is executed.
 */
const updateList  = new ValidatedMethod({
    name: 'list.update',
    validate: null,
    run([docId, obj]) {
        //return List.update(docId, {$set: obj});
    }
});
 ...
 * @property { function }   run         The main action that is executed.
 */
const removeList  = new ValidatedMethod({
    name: 'list.remove',
    validate: null,
    run(docId) {
        //return List.remove(docId);
    }
});

const RATE_LIMITED_METHODS = _.pluck([
    insertList , updateList , removeList
], 'name');
