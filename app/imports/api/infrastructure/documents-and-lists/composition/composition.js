 ...
 */
class CompositionCollection extends Mongo.Collection {
    /**
     * @public
 ...
 * You may modify (not recommended) these permissions on the Composition.deny() line.
* @memberof Server.Composition
* @member Composition
*/
export const Composition = new CompositionCollection('Composition');
 ...
 * @see ./publications.js
 */
Composition.publicFields = {};
Composition.privateFields = {};
