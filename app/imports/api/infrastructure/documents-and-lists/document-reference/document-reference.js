 ...
 */
class DocumentReferenceCollection extends Mongo.Collection {
    /**
     * @public
 ...
 * You may modify (not recommended) these permissions on the DocumentReference.deny() line.
* @memberof Server.DocumentReference
* @member DocumentReference
*/
export const DocumentReference = new DocumentReferenceCollection('DocumentReference');

/**
 * Set the client side access rights to the Cases collection.
 * Default: Deny all
 */
DocumentReference.deny({
    insert() { return true; },
    update() { return true; },
    remove() { return true; }
});
 ...
 * @see ./publications.js
 */
DocumentReference.publicFields = {};
DocumentReference.privateFields = {};
