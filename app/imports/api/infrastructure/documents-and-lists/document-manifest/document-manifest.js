 ...
 */
class DocumentManifestCollection extends Mongo.Collection {
    /**
     * @public
 ...
 * You may modify (not recommended) these permissions on the DocumentManifest.deny() line.
* @memberof Server.DocumentManifest
* @member DocumentManifest
*/
export const DocumentManifest = new DocumentManifestCollection('DocumentManifest');

/**
 * Set the client side access rights to the Cases collection.
 * Default: Deny all
 */
DocumentManifest.deny({
    insert() { return true; },
    update() { return true; },
    remove() { return true; }
});
 ...
 * @see ./publications.js
 */
DocumentManifest.publicFields = {};
DocumentManifest.privateFields = {};
