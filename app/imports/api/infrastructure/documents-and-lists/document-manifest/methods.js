 ...
 */
const insertDocumentManifest = new ValidatedMethod({
    name: 'document-manifest.insert',
    validate: null,
    run(doc) {
        //return DocumentManifest.insert(doc);
    }
});
 ...
 * @property { function }   run         The main action that is executed.
 */
const updateDocumentManifest  = new ValidatedMethod({
    name: 'document-manifest.update',
    validate: null,
    run([docId, obj]) {
        //return DocumentManifest.update(docId, {$set: obj});
    }
});
 ...
 * @property { function }   run         The main action that is executed.
 */
const removeDocumentManifest  = new ValidatedMethod({
    name: 'document-manifest.remove',
    validate: null,
    run(docId) {
        //return DocumentManifest.remove(docId);
    }
});

const RATE_LIMITED_METHODS = _.pluck([
    insertDocumentManifest , updateDocumentManifest , removeDocumentManifest
], 'name');
