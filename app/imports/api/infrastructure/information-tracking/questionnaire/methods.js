 ...
 */
const insertQuestionnaire = new ValidatedMethod({
    name: 'questionnaire.insert',
    validate: null,
    run(doc) {
        //return Questionnaire.insert(doc);
    }
});
 ...
 * @property { function }   run         The main action that is executed.
 */
const updateQuestionnaire  = new ValidatedMethod({
    name: 'questionnaire.update',
    validate: null,
    run([docId, obj]) {
        //return Questionnaire.update(docId, {$set: obj});
    }
});
 ...
 * @property { function }   run         The main action that is executed.
 */
const removeQuestionnaire  = new ValidatedMethod({
    name: 'questionnaire.remove',
    validate: null,
    run(docId) {
        //return Questionnaire.remove(docId);
    }
});

const RATE_LIMITED_METHODS = _.pluck([
    insertQuestionnaire , updateQuestionnaire , removeQuestionnaire
], 'name');
