 ...
 */
class QuestionnaireCollection extends Mongo.Collection {
    /**
     * @public
 ...
 * You may modify (not recommended) these permissions on the Questionnaire.deny() line.
* @memberof Server.Questionnaire
* @member Questionnaire
*/
export const Questionnaire = new QuestionnaireCollection('Questionnaire');
 ...
 * @see ./publications.js
 */
Questionnaire.publicFields = {};
Questionnaire.privateFields = {};
