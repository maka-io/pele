 ...
 */
class ProvenanaceCollection extends Mongo.Collection {
    /**
     * @public
 ...
 * You may modify (not recommended) these permissions on the Provenanace.deny() line.
* @memberof Server.Provenanace
* @member Provenanace
*/
export const Provenanace = new ProvenanaceCollection('Provenanace');
 ...
 * @see ./publications.js
 */
Provenanace.publicFields = {};
Provenanace.privateFields = {};
