 ...
 */
const insertProvenanace = new ValidatedMethod({
    name: 'provenanace.insert',
    validate: null,
    run(doc) {
        //return Provenanace.insert(doc);
    }
});
 ...
 * @property { function }   run         The main action that is executed.
 */
const updateProvenanace  = new ValidatedMethod({
    name: 'provenanace.update',
    validate: null,
    run([docId, obj]) {
        //return Provenanace.update(docId, {$set: obj});
    }
});
 ...
 * @property { function }   run         The main action that is executed.
 */
const removeProvenanace  = new ValidatedMethod({
    name: 'provenanace.remove',
    validate: null,
    run(docId) {
        //return Provenanace.remove(docId);
    }
});

const RATE_LIMITED_METHODS = _.pluck([
    insertProvenanace , updateProvenanace , removeProvenanace
], 'name');
