 ...
 */
class QuestionnaireResponseCollection extends Mongo.Collection {
    /**
     * @public
 ...
 * You may modify (not recommended) these permissions on the QuestionnaireResponse.deny() line.
* @memberof Server.QuestionnaireResponse
* @member QuestionnaireResponse
*/
export const QuestionnaireResponse = new QuestionnaireResponseCollection('QuestionnaireResponse');

/**
 * Set the client side access rights to the Cases collection.
 * Default: Deny all
 */
QuestionnaireResponse.deny({
    insert() { return true; },
    update() { return true; },
    remove() { return true; }
});
 ...
 * @see ./publications.js
 */
QuestionnaireResponse.publicFields = {};
QuestionnaireResponse.privateFields = {};
