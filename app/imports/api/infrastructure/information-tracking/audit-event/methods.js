 ...
 */
const insertAuditEvent = new ValidatedMethod({
    name: 'audit-event.insert',
    validate: null,
    run(doc) {
        //return AuditEvent.insert(doc);
    }
});
 ...
 * @property { function }   run         The main action that is executed.
 */
const updateAuditEvent  = new ValidatedMethod({
    name: 'audit-event.update',
    validate: null,
    run([docId, obj]) {
        //return AuditEvent.update(docId, {$set: obj});
    }
});
 ...
 * @property { function }   run         The main action that is executed.
 */
const removeAuditEvent  = new ValidatedMethod({
    name: 'audit-event.remove',
    validate: null,
    run(docId) {
        //return AuditEvent.remove(docId);
    }
});

const RATE_LIMITED_METHODS = _.pluck([
    insertAuditEvent , updateAuditEvent , removeAuditEvent
], 'name');
