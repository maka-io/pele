 ...
 */
class AuditEventCollection extends Mongo.Collection {
    /**
     * @public
 ...
 * You may modify (not recommended) these permissions on the AuditEvent.deny() line.
* @memberof Server.AuditEvent
* @member AuditEvent
*/
export const AuditEvent = new AuditEventCollection('AuditEvent');
 ...
 * @see ./publications.js
 */
AuditEvent.publicFields = {};
AuditEvent.privateFields = {};
