 ...
 */
const insertParameters = new ValidatedMethod({
    name: 'parameters.insert',
    validate: null,
    run(doc) {
        //return Parameters.insert(doc);
    }
});
 ...
 * @property { function }   run         The main action that is executed.
 */
const updateParameters  = new ValidatedMethod({
    name: 'parameters.update',
    validate: null,
    run([docId, obj]) {
        //return Parameters.update(docId, {$set: obj});
    }
});
 ...
 * @property { function }   run         The main action that is executed.
 */
const removeParameters  = new ValidatedMethod({
    name: 'parameters.remove',
    validate: null,
    run(docId) {
        //return Parameters.remove(docId);
    }
});

const RATE_LIMITED_METHODS = _.pluck([
    insertParameters , updateParameters , removeParameters
], 'name');
