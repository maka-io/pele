 ...
 */
class ParametersCollection extends Mongo.Collection {
    /**
     * @public
 ...
 * You may modify (not recommended) these permissions on the Parameters.deny() line.
* @memberof Server.Parameters
* @member Parameters
*/
export const Parameters = new ParametersCollection('Parameters');
