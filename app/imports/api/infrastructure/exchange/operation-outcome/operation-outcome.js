 ...
 */
class OperationOutcomeCollection extends Mongo.Collection {
    /**
     * @public
 ...
 * You may modify (not recommended) these permissions on the OperationOutcome.deny() line.
* @memberof Server.OperationOutcome
* @member OperationOutcome
*/
export const OperationOutcome = new OperationOutcomeCollection('OperationOutcome');

/**
 * Set the client side access rights to the Cases collection.
 * Default: Deny all
 */
OperationOutcome.deny({
    insert() { return true; },
    update() { return true; },
    remove() { return true; }
});
 ...
 * @see ./publications.js
 */
OperationOutcome.publicFields = {};
OperationOutcome.privateFields = {};
