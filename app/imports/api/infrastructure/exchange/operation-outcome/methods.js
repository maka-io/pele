 ...
 */
const insertOperationOutcome = new ValidatedMethod({
    name: 'operation-outcome.insert',
    validate: null,
    run(doc) {
        //return OperationOutcome.insert(doc);
    }
});
 ...
 * @property { function }   run         The main action that is executed.
 */
const updateOperationOutcome  = new ValidatedMethod({
    name: 'operation-outcome.update',
    validate: null,
    run([docId, obj]) {
        //return OperationOutcome.update(docId, {$set: obj});
    }
});
 ...
 * @property { function }   run         The main action that is executed.
 */
const removeOperationOutcome  = new ValidatedMethod({
    name: 'operation-outcome.remove',
    validate: null,
    run(docId) {
        //return OperationOutcome.remove(docId);
    }
});

const RATE_LIMITED_METHODS = _.pluck([
    insertOperationOutcome , updateOperationOutcome , removeOperationOutcome
], 'name');
