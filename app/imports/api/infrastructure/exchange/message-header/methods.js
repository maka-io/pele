 ...
 */
const insertMessageHeader = new ValidatedMethod({
    name: 'message-header.insert',
    validate: null,
    run(doc) {
        //return MessageHeader.insert(doc);
    }
});
 ...
 * @property { function }   run         The main action that is executed.
 */
const updateMessageHeader  = new ValidatedMethod({
    name: 'message-header.update',
    validate: null,
    run([docId, obj]) {
        //return MessageHeader.update(docId, {$set: obj});
    }
});
 ...
 * @property { function }   run         The main action that is executed.
 */
const removeMessageHeader  = new ValidatedMethod({
    name: 'message-header.remove',
    validate: null,
    run(docId) {
        //return MessageHeader.remove(docId);
    }
});

const RATE_LIMITED_METHODS = _.pluck([
    insertMessageHeader , updateMessageHeader , removeMessageHeader
], 'name');
