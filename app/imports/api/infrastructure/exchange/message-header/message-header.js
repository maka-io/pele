 ...
 */
class MessageHeaderCollection extends Mongo.Collection {
    /**
     * @public
 ...
 * You may modify (not recommended) these permissions on the MessageHeader.deny() line.
* @memberof Server.MessageHeader
* @member MessageHeader
*/
export const MessageHeader = new MessageHeaderCollection('MessageHeader');
 ...
 * @see ./publications.js
 */
MessageHeader.publicFields = {};
MessageHeader.privateFields = {};
