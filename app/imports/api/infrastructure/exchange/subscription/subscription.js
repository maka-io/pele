 ...
 */
class SubscriptionCollection extends Mongo.Collection {
    /**
     * @public
 ...
 * You may modify (not recommended) these permissions on the Subscription.deny() line.
* @memberof Server.Subscription
* @member Subscription
*/
export const Subscription = new SubscriptionCollection('Subscription');
 ...
 * @see ./publications.js
 */
Subscription.publicFields = {};
Subscription.privateFields = {};
