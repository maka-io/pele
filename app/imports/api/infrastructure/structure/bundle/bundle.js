 ...
 */
class BundleCollection extends Mongo.Collection {
    /**
     * @public
 ...
 * You may modify (not recommended) these permissions on the Bundle.deny() line.
* @memberof Server.Bundle
* @member Bundle
*/
export const Bundle = new BundleCollection('Bundle');
