 ...
 */
const insertBasic = new ValidatedMethod({
    name: 'basic.insert',
    validate: null,
    run(doc) {
        //return Basic.insert(doc);
    }
});
 ...
 * @property { function }   run         The main action that is executed.
 */
const updateBasic  = new ValidatedMethod({
    name: 'basic.update',
    validate: null,
    run([docId, obj]) {
        //return Basic.update(docId, {$set: obj});
    }
});
 ...
 * @property { function }   run         The main action that is executed.
 */
const removeBasic  = new ValidatedMethod({
    name: 'basic.remove',
    validate: null,
    run(docId) {
        //return Basic.remove(docId);
    }
});

const RATE_LIMITED_METHODS = _.pluck([
    insertBasic , updateBasic , removeBasic
], 'name');
