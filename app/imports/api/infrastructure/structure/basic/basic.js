 ...
 */
class BasicCollection extends Mongo.Collection {
    /**
     * @public
 ...
 * You may modify (not recommended) these permissions on the Basic.deny() line.
* @memberof Server.Basic
* @member Basic
*/
export const Basic = new BasicCollection('Basic');
