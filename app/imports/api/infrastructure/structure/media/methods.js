 ...
 */
const insertMedia = new ValidatedMethod({
    name: 'media.insert',
    validate: null,
    run(doc) {
 ...
 * @property { function }   run         The main action that is executed.
 */
const updateMedia  = new ValidatedMethod({
    name: 'media.update',
    validate: null,
    run([docId, obj]) {
        //return Media.update(docId, {$set: obj});
    }
});
 ...
 * @property { function }   run         The main action that is executed.
 */
const removeMedia  = new ValidatedMethod({
    name: 'media.remove',
    validate: null,
    run(docId) {
        //return Media.remove(docId);
    }
});

const RATE_LIMITED_METHODS = _.pluck([
    insertMedia , updateMedia , removeMedia
], 'name');
