 ...
 */
class MediaCollection extends Mongo.Collection {
    /**
     * @public
 ...
 * You may modify (not recommended) these permissions on the Media.deny() line.
* @memberof Server.Media
* @member Media
*/
export const Media = new MediaCollection('Media');
