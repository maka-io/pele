 ...
 */
class BinaryCollection extends Mongo.Collection {
    /**
     * @public
 ...
 * You may modify (not recommended) these permissions on the Binary.deny() line.
* @memberof Server.Binary
* @member Binary
*/
export const Binary = new BinaryCollection('Binary');
