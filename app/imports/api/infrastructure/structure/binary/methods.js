 ...
 */
const insertBinary = new ValidatedMethod({
    name: 'binary.insert',
    validate: null,
    run(doc) {
        //return Binary.insert(doc);
    }
});
 ...
 * @property { function }   run         The main action that is executed.
 */
const updateBinary  = new ValidatedMethod({
    name: 'binary.update',
    validate: null,
    run([docId, obj]) {
        //return Binary.update(docId, {$set: obj});
    }
});
 ...
 * @property { function }   run         The main action that is executed.
 */
const removeBinary  = new ValidatedMethod({
    name: 'binary.remove',
    validate: null,
    run(docId) {
        //return Binary.remove(docId);
    }
});

const RATE_LIMITED_METHODS = _.pluck([
    insertBinary , updateBinary , removeBinary
], 'name');
