 ...
 */
class DeviceUseStatementCollection extends Mongo.Collection {
    /**
     * @public
 ...
 * You may modify (not recommended) these permissions on the DeviceUseStatement.deny() line.
* @memberof Server.DeviceUseStatement
* @member DeviceUseStatement
*/
export const DeviceUseStatement = new DeviceUseStatementCollection('DeviceUseStatement');

/**
 * Set the client side access rights to the Cases collection.
 * Default: Deny all
 */
DeviceUseStatement.deny({
    insert() { return true; },
    update() { return true; },
    remove() { return true; }
});
 ...
 * @see ./publications.js
 */
DeviceUseStatement.publicFields = {};
DeviceUseStatement.privateFields = {};
