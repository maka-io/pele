 ...
 */
class OrderResponseCollection extends Mongo.Collection {
    /**
     * @public
 ...
 * You may modify (not recommended) these permissions on the OrderResponse.deny() line.
* @memberof Server.OrderResponse
* @member OrderResponse
*/
export const OrderResponse = new OrderResponseCollection('OrderResponse');
 ...
 * @see ./publications.js
 */
OrderResponse.publicFields = {};
OrderResponse.privateFields = {};
