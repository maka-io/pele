 ...
 */
class CommunicationRequestCollection extends Mongo.Collection {
    /**
     * @public
 ...
 * You may modify (not recommended) these permissions on the CommunicationRequest.deny() line.
* @memberof Server.CommunicationRequest
* @member CommunicationRequest
*/
export const CommunicationRequest = new CommunicationRequestCollection('CommunicationRequest');

/**
 * Set the client side access rights to the Cases collection.
 * Default: Deny all
 */
CommunicationRequest.deny({
    insert() { return true; },
    update() { return true; },
    remove() { return true; }
});
 ...
 * @see ./publications.js
 */
CommunicationRequest.publicFields = {};
CommunicationRequest.privateFields = {};
