 ...
 */
class ProcessRequestCollection extends Mongo.Collection {
    /**
     * @public
 ...
 * You may modify (not recommended) these permissions on the ProcessRequest.deny() line.
* @memberof Server.ProcessRequest
* @member ProcessRequest
*/
export const ProcessRequest = new ProcessRequestCollection('ProcessRequest');
 ...
 * @see ./publications.js
 */
ProcessRequest.publicFields = {};
ProcessRequest.privateFields = {};
