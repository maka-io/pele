 ...
 */
const insertProcessRequest = new ValidatedMethod({
    name: 'process-request.insert',
    validate: null,
    run(doc) {
        //return ProcessRequest.insert(doc);
    }
});
 ...
 * @property { function }   run         The main action that is executed.
 */
const updateProcessRequest  = new ValidatedMethod({
    name: 'process-request.update',
    validate: null,
    run([docId, obj]) {
        //return ProcessRequest.update(docId, {$set: obj});
    }
});
 ...
 * @property { function }   run         The main action that is executed.
 */
const removeProcessRequest  = new ValidatedMethod({
    name: 'process-request.remove',
    validate: null,
    run(docId) {
        //return ProcessRequest.remove(docId);
    }
});

const RATE_LIMITED_METHODS = _.pluck([
    insertProcessRequest , updateProcessRequest , removeProcessRequest
], 'name');
