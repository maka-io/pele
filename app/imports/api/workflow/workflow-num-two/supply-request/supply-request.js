 ...
 */
class SupplyRequestCollection extends Mongo.Collection {
    /**
     * @public
 ...
 * You may modify (not recommended) these permissions on the SupplyRequest.deny() line.
* @memberof Server.SupplyRequest
* @member SupplyRequest
*/
export const SupplyRequest = new SupplyRequestCollection('SupplyRequest');
 ...
 * @see ./publications.js
 */
SupplyRequest.publicFields = {};
SupplyRequest.privateFields = {};
