 ...
 */
const insertProcessResponse = new ValidatedMethod({
    name: 'process-response.insert',
    validate: null,
    run(doc) {
        //return ProcessResponse.insert(doc);
    }
});
 ...
 * @property { function }   run         The main action that is executed.
 */
const updateProcessResponse  = new ValidatedMethod({
    name: 'process-response.update',
    validate: null,
    run([docId, obj]) {
        //return ProcessResponse.update(docId, {$set: obj});
    }
});
 ...
 * @property { function }   run         The main action that is executed.
 */
const removeProcessResponse  = new ValidatedMethod({
    name: 'process-response.remove',
    validate: null,
    run(docId) {
        //return ProcessResponse.remove(docId);
    }
});

const RATE_LIMITED_METHODS = _.pluck([
    insertProcessResponse , updateProcessResponse , removeProcessResponse
], 'name');
