 ...
 */
class ProcessResponseCollection extends Mongo.Collection {
    /**
     * @public
 ...
 * You may modify (not recommended) these permissions on the ProcessResponse.deny() line.
* @memberof Server.ProcessResponse
* @member ProcessResponse
*/
export const ProcessResponse = new ProcessResponseCollection('ProcessResponse');
 ...
 * @see ./publications.js
 */
ProcessResponse.publicFields = {};
ProcessResponse.privateFields = {};
