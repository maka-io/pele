 ...
 */
const insertAppointmentResponse = new ValidatedMethod({
    name: 'appointment-response.insert',
    validate: null,
    run(doc) {
        //return AppointmentResponse.insert(doc);
    }
});
 ...
 * @property { function }   run         The main action that is executed.
 */
const updateAppointmentResponse  = new ValidatedMethod({
    name: 'appointment-response.update',
    validate: null,
    run([docId, obj]) {
        //return AppointmentResponse.update(docId, {$set: obj});
    }
});
 ...
 * @property { function }   run         The main action that is executed.
 */
const removeAppointmentResponse  = new ValidatedMethod({
    name: 'appointment-response.remove',
    validate: null,
    run(docId) {
        //return AppointmentResponse.remove(docId);
    }
});

const RATE_LIMITED_METHODS = _.pluck([
    insertAppointmentResponse , updateAppointmentResponse , removeAppointmentResponse
], 'name');
