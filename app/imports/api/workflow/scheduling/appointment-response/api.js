 ...
 */
const AppointmentResponseApiV1 = new Restivus({
    version: 'v1',
    useDefaultAuth: true,
...
// Uncommenting below will expose ALL routes for AppointmentResponse
//
// Please review restivus documentation on how to harden endpoints.
//
// USE WITH CAUTION... can you imagine - $ maka g:api BankRecords
AppointmentResponseApiV1.addCollection(AppointmentResponse);
