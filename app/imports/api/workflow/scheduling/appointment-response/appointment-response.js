 ...
 */
class AppointmentResponseCollection extends Mongo.Collection {
    /**
     * @public
 ...
 * You may modify (not recommended) these permissions on the AppointmentResponse.deny() line.
* @memberof Server.AppointmentResponse
* @member AppointmentResponse
*/
export const AppointmentResponse = new AppointmentResponseCollection('AppointmentResponse');

/**
 * Set the client side access rights to the Cases collection.
 * Default: Deny all
 */
AppointmentResponse.deny({
    insert() { return true; },
    update() { return true; },
    remove() { return true; }
});
 ...
 * @see ./publications.js
 */
AppointmentResponse.publicFields = {};
AppointmentResponse.privateFields = {};
