 ...
 */
class AppointmentCollection extends Mongo.Collection {
    /**
     * @public
 ...
 * You may modify (not recommended) these permissions on the Appointment.deny() line.
* @memberof Server.Appointment
* @member Appointment
*/
export const Appointment = new AppointmentCollection('Appointment');
 ...
 * @see ./publications.js
 */
Appointment.publicFields = {};
Appointment.privateFields = {};
