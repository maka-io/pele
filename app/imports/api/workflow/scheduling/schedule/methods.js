 ...
 */
const insertSchedule = new ValidatedMethod({
    name: 'schedule.insert',
    validate: null,
    run(doc) {
        //return Schedule.insert(doc);
    }
});
 ...
 * @property { function }   run         The main action that is executed.
 */
const updateSchedule  = new ValidatedMethod({
    name: 'schedule.update',
    validate: null,
    run([docId, obj]) {
        //return Schedule.update(docId, {$set: obj});
    }
});
 ...
 * @property { function }   run         The main action that is executed.
 */
const removeSchedule  = new ValidatedMethod({
    name: 'schedule.remove',
    validate: null,
    run(docId) {
        //return Schedule.remove(docId);
    }
});

const RATE_LIMITED_METHODS = _.pluck([
    insertSchedule , updateSchedule , removeSchedule
], 'name');
