 ...
 */
class ScheduleCollection extends Mongo.Collection {
    /**
     * @public
 ...
 * You may modify (not recommended) these permissions on the Schedule.deny() line.
* @memberof Server.Schedule
* @member Schedule
*/
export const Schedule = new ScheduleCollection('Schedule');
 ...
 * @see ./publications.js
 */
Schedule.publicFields = {};
Schedule.privateFields = {};
