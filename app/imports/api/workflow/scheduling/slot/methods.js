 ...
 */
const insertSlot = new ValidatedMethod({
    name: 'slot.insert',
    validate: null,
    run(doc) {
        //return Slot.insert(doc);
    }
});
 ...
 * @property { function }   run         The main action that is executed.
 */
const updateSlot  = new ValidatedMethod({
    name: 'slot.update',
    validate: null,
    run([docId, obj]) {
        //return Slot.update(docId, {$set: obj});
    }
});
 ...
 * @property { function }   run         The main action that is executed.
 */
const removeSlot  = new ValidatedMethod({
    name: 'slot.remove',
    validate: null,
    run(docId) {
        //return Slot.remove(docId);
    }
});
