 ...
 */
class SlotCollection extends Mongo.Collection {
    /**
     * @public
 ...
 * You may modify (not recommended) these permissions on the Slot.deny() line.
* @memberof Server.Slot
* @member Slot
*/
export const Slot = new SlotCollection('Slot');
