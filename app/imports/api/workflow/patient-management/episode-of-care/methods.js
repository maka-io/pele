 ...
 */
const insertEpisodeOfCare = new ValidatedMethod({
    name: 'episode-of-care.insert',
    validate: null,
    run(doc) {
        //return EpisodeOfCare.insert(doc);
    }
});
 ...
 * @property { function }   run         The main action that is executed.
 */
const updateEpisodeOfCare  = new ValidatedMethod({
    name: 'episode-of-care.update',
    validate: null,
    run([docId, obj]) {
        //return EpisodeOfCare.update(docId, {$set: obj});
    }
});
 ...
 * @property { function }   run         The main action that is executed.
 */
const removeEpisodeOfCare  = new ValidatedMethod({
    name: 'episode-of-care.remove',
    validate: null,
    run(docId) {
        //return EpisodeOfCare.remove(docId);
    }
});

const RATE_LIMITED_METHODS = _.pluck([
    insertEpisodeOfCare , updateEpisodeOfCare , removeEpisodeOfCare
], 'name');
