 ...
 */
class EpisodeOfCareCollection extends Mongo.Collection {
    /**
     * @public
 ...
 * You may modify (not recommended) these permissions on the EpisodeOfCare.deny() line.
* @memberof Server.EpisodeOfCare
* @member EpisodeOfCare
*/
export const EpisodeOfCare = new EpisodeOfCareCollection('EpisodeOfCare');
 ...
 * @see ./publications.js
 */
EpisodeOfCare.publicFields = {};
EpisodeOfCare.privateFields = {};
