 ...
 */
const insertFlag = new ValidatedMethod({
    name: 'flag.insert',
    validate: null,
    run(doc) {
        //return Flag.insert(doc);
    }
});
 ...
 * @property { function }   run         The main action that is executed.
 */
const updateFlag  = new ValidatedMethod({
    name: 'flag.update',
    validate: null,
    run([docId, obj]) {
        //return Flag.update(docId, {$set: obj});
    }
});
 ...
 * @property { function }   run         The main action that is executed.
 */
const removeFlag  = new ValidatedMethod({
    name: 'flag.remove',
    validate: null,
    run(docId) {
        //return Flag.remove(docId);
    }
});

const RATE_LIMITED_METHODS = _.pluck([
    insertFlag , updateFlag , removeFlag
], 'name');
