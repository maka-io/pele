 ...
 */
class FlagCollection extends Mongo.Collection {
    /**
     * @public
 ...
 * You may modify (not recommended) these permissions on the Flag.deny() line.
* @memberof Server.Flag
* @member Flag
*/
export const Flag = new FlagCollection('Flag');
