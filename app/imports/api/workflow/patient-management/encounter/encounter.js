 ...
 */
class EncounterCollection extends Mongo.Collection {
    /**
     * @public
 ...
 * You may modify (not recommended) these permissions on the Encounter.deny() line.
* @memberof Server.Encounter
* @member Encounter
*/
export const Encounter = new EncounterCollection('Encounter');
 ...
 * @see ./publications.js
 */
Encounter.publicFields = {};
Encounter.privateFields = {};
