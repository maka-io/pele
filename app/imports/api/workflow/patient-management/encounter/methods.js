 ...
 */
const insertEncounter = new ValidatedMethod({
    name: 'encounter.insert',
    validate: null,
    run(doc) {
        //return Encounter.insert(doc);
    }
});
 ...
 * @property { function }   run         The main action that is executed.
 */
const updateEncounter  = new ValidatedMethod({
    name: 'encounter.update',
    validate: null,
    run([docId, obj]) {
        //return Encounter.update(docId, {$set: obj});
    }
});
 ...
 * @property { function }   run         The main action that is executed.
 */
const removeEncounter  = new ValidatedMethod({
    name: 'encounter.remove',
    validate: null,
    run(docId) {
        //return Encounter.remove(docId);
    }
});
