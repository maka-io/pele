 ...
 */
const insertCommunication = new ValidatedMethod({
    name: 'communication.insert',
    validate: null,
    run(doc) {
        //return Communication.insert(doc);
    }
});
 ...
 * @property { function }   run         The main action that is executed.
 */
const updateCommunication  = new ValidatedMethod({
    name: 'communication.update',
    validate: null,
    run([docId, obj]) {
        //return Communication.update(docId, {$set: obj});
    }
});
 ...
 * @property { function }   run         The main action that is executed.
 */
const removeCommunication  = new ValidatedMethod({
    name: 'communication.remove',
    validate: null,
    run(docId) {
        //return Communication.remove(docId);
    }
});

const RATE_LIMITED_METHODS = _.pluck([
    insertCommunication , updateCommunication , removeCommunication
], 'name');
