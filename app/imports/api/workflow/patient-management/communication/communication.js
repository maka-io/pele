 ...
 */
class CommunicationCollection extends Mongo.Collection {
    /**
     * @public
 ...
 * You may modify (not recommended) these permissions on the Communication.deny() line.
* @memberof Server.Communication
* @member Communication
*/
export const Communication = new CommunicationCollection('Communication');
