 ...
 */
class ContractCollection extends Mongo.Collection {
    /**
     * @public
 ...
 * You may modify (not recommended) these permissions on the Contract.deny() line.
* @memberof Server.Contract
* @member Contract
*/
export const Contract = new ContractCollection('Contract');
