 ...
 */
class LocationCollection extends Mongo.Collection {
    /**
     * @public
 ...
 * You may modify (not recommended) these permissions on the Location.deny() line.
* @memberof Server.Location
* @member Location
*/
export const Location = new LocationCollection('Location');
