 ...
 */
class PersonCollection extends Mongo.Collection {
    /**
     * @public
 ...
 * You may modify (not recommended) these permissions on the Person.deny() line.
* @memberof Server.Person
* @member Person
*/
export const Person = new PersonCollection('Person');
