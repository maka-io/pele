 ...
 */
class SubstanceCollection extends Mongo.Collection {
    /**
     * @public
 ...
 * You may modify (not recommended) these permissions on the Substance.deny() line.
* @memberof Server.Substance
* @member Substance
*/
export const Substance = new SubstanceCollection('Substance');
 ...
 * @see ./publications.js
 */
Substance.publicFields = {};
Substance.privateFields = {};
