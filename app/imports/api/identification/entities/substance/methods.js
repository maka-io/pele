 ...
 */
const insertSubstance = new ValidatedMethod({
    name: 'substance.insert',
    validate: null,
    run(doc) {
        //return Substance.insert(doc);
    }
});
 ...
 * @property { function }   run         The main action that is executed.
 */
const updateSubstance  = new ValidatedMethod({
    name: 'substance.update',
    validate: null,
    run([docId, obj]) {
        //return Substance.update(docId, {$set: obj});
    }
});
 ...
 * @property { function }   run         The main action that is executed.
 */
const removeSubstance  = new ValidatedMethod({
    name: 'substance.remove',
    validate: null,
    run(docId) {
        //return Substance.remove(docId);
    }
});

const RATE_LIMITED_METHODS = _.pluck([
    insertSubstance , updateSubstance , removeSubstance
], 'name');
