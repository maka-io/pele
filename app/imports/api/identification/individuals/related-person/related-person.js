 ...
 */
class RelatedPersonCollection extends Mongo.Collection {
    /**
     * @public
 ...
 * You may modify (not recommended) these permissions on the RelatedPerson.deny() line.
* @memberof Server.RelatedPerson
* @member RelatedPerson
*/
export const RelatedPerson = new RelatedPersonCollection('RelatedPerson');
 ...
 * @see ./publications.js
 */
RelatedPerson.publicFields = {};
RelatedPerson.privateFields = {};
