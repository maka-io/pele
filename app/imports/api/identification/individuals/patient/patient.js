 ...
 * You may modify (not recommended) these permissions on the Patient.deny() line.
* @memberof Server.Patient
* @member Patient
*/
export const Patient = new PatientCollection('Patient');
 ...
 * @see ./publications.js
 */
Patient.publicFields = {};
Patient.privateFields = {};
