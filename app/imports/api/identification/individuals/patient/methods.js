 ...
 */
const insertPatient = new ValidatedMethod({
    name: 'patient.insert',
    validate: null,
    run(doc) {
        //return Patient.insert(doc);
    }
});
 ...
 * @property { function }   run         The main action that is executed.
 */
const updatePatient  = new ValidatedMethod({
    name: 'patient.update',
    validate: null,
    run([docId, obj]) {
        //return Patient.update(docId, {$set: obj});
    }
});
 ...
 * @property { function }   run         The main action that is executed.
 */
const removePatient  = new ValidatedMethod({
    name: 'patient.remove',
    validate: null,
    run(docId) {
        //return Patient.remove(docId);
    }
});

const RATE_LIMITED_METHODS = _.pluck([
    insertPatient , updatePatient , removePatient
], 'name');
