 ...
 */
class PractitionerCollection extends Mongo.Collection {
    /**
     * @public
 ...
 * You may modify (not recommended) these permissions on the Practitioner.deny() line.
* @memberof Server.Practitioner
* @member Practitioner
*/
export const Practitioner = new PractitionerCollection('Practitioner');
 ...
 * @see ./publications.js
 */
Practitioner.publicFields = {};
Practitioner.privateFields = {};
