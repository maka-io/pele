 ...
 */
const insertGroup = new ValidatedMethod({
    name: 'group.insert',
    validate: null,
    run(doc) {
        //return Group.insert(doc);
    }
});
 ...
 * @property { function }   run         The main action that is executed.
 */
const updateGroup  = new ValidatedMethod({
    name: 'group.update',
    validate: null,
    run([docId, obj]) {
        //return Group.update(docId, {$set: obj});
    }
});
 ...
 * @property { function }   run         The main action that is executed.
 */
const removeGroup  = new ValidatedMethod({
    name: 'group.remove',
    validate: null,
    run(docId) {
        //return Group.remove(docId);
    }
});

const RATE_LIMITED_METHODS = _.pluck([
    insertGroup , updateGroup , removeGroup
], 'name');
