 ...
 */
class HealthcareServiceCollection extends Mongo.Collection {
    /**
     * @public
 ...
 * You may modify (not recommended) these permissions on the HealthcareService.deny() line.
* @memberof Server.HealthcareService
* @member HealthcareService
*/
export const HealthcareService = new HealthcareServiceCollection('HealthcareService');

/**
 * Set the client side access rights to the Cases collection.
 * Default: Deny all
 */
HealthcareService.deny({
    insert() { return true; },
    update() { return true; },
    remove() { return true; }
});
 ...
 * @see ./publications.js
 */
HealthcareService.publicFields = {};
HealthcareService.privateFields = {};
