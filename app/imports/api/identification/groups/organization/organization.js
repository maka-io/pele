 ...
 */
class OrganizationCollection extends Mongo.Collection {
    /**
     * @public
 ...
 * You may modify (not recommended) these permissions on the Organization.deny() line.
* @memberof Server.Organization
* @member Organization
*/
export const Organization = new OrganizationCollection('Organization');
