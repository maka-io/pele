 ...
 */
const insertOrganization = new ValidatedMethod({
    name: 'organization.insert',
    validate: null,
    run(doc) {
        //return Organization.insert(doc);
    }
});
 ...
 * @property { function }   run         The main action that is executed.
 */
const updateOrganization  = new ValidatedMethod({
    name: 'organization.update',
    validate: null,
    run([docId, obj]) {
        //return Organization.update(docId, {$set: obj});
    }
});
 ...
 * @property { function }   run         The main action that is executed.
 */
const removeOrganization  = new ValidatedMethod({
    name: 'organization.remove',
    validate: null,
    run(docId) {
        //return Organization.remove(docId);
    }
});

const RATE_LIMITED_METHODS = _.pluck([
    insertOrganization , updateOrganization , removeOrganization
], 'name');
