 ...
 */
class DeviceComponentCollection extends Mongo.Collection {
    /**
     * @public
 ...
 * You may modify (not recommended) these permissions on the DeviceComponent.deny() line.
* @memberof Server.DeviceComponent
* @member DeviceComponent
*/
export const DeviceComponent = new DeviceComponentCollection('DeviceComponent');

/**
 * Set the client side access rights to the Cases collection.
 * Default: Deny all
 */
DeviceComponent.deny({
    insert() { return true; },
    update() { return true; },
    remove() { return true; }
});
 ...
 * @see ./publications.js
 */
DeviceComponent.publicFields = {};
DeviceComponent.privateFields = {};
