 ...
 */
const insertDeviceComponent = new ValidatedMethod({
    name: 'device-component.insert',
    validate: null,
    run(doc) {
        //return DeviceComponent.insert(doc);
    }
});
 ...
 * @property { function }   run         The main action that is executed.
 */
const updateDeviceComponent  = new ValidatedMethod({
    name: 'device-component.update',
    validate: null,
    run([docId, obj]) {
        //return DeviceComponent.update(docId, {$set: obj});
    }
});
 ...
 * @property { function }   run         The main action that is executed.
 */
const removeDeviceComponent  = new ValidatedMethod({
    name: 'device-component.remove',
    validate: null,
    run(docId) {
        //return DeviceComponent.remove(docId);
    }
});

const RATE_LIMITED_METHODS = _.pluck([
    insertDeviceComponent , updateDeviceComponent , removeDeviceComponent
], 'name');
