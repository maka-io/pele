 ...
 */
class DeviceCollection extends Mongo.Collection {
    /**
     * @public
 ...
 * You may modify (not recommended) these permissions on the Device.deny() line.
* @memberof Server.Device
* @member Device
*/
export const Device = new DeviceCollection('Device');
