 ...
 */
const insertDevice = new ValidatedMethod({
    name: 'device.insert',
    validate: null,
    run(doc) {
        //return Device.insert(doc);
    }
});
 ...
 * @property { function }   run         The main action that is executed.
 */
const updateDevice  = new ValidatedMethod({
    name: 'device.update',
    validate: null,
    run([docId, obj]) {
        //return Device.update(docId, {$set: obj});
    }
});
 ...
 * @property { function }   run         The main action that is executed.
 */
const removeDevice  = new ValidatedMethod({
    name: 'device.remove',
    validate: null,
    run(docId) {
        //return Device.remove(docId);
    }
});

const RATE_LIMITED_METHODS = _.pluck([
    insertDevice , updateDevice , removeDevice
], 'name');
