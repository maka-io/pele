 ...
 */
class DeviceMetricCollection extends Mongo.Collection {
    /**
     * @public
 ...
 * You may modify (not recommended) these permissions on the DeviceMetric.deny() line.
* @memberof Server.DeviceMetric
* @member DeviceMetric
*/
export const DeviceMetric = new DeviceMetricCollection('DeviceMetric');
 ...
 * @see ./publications.js
 */
DeviceMetric.publicFields = {};
DeviceMetric.privateFields = {};
